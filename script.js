...
employees = employees.map((employee) => {
  ...
  upDatedEmployee.minAmount = employee.offerPrice.sort(
    (a, b) => a.amount - b.amount
  )[0].amount;
  upDatedEmployee.maxAmount = employee.offerPrice.sort(
...
const renderTable = (rendrableEmployees) => {
  ...
  rendrableEmployees.forEach((employee, index) => {
    table.innerHTML += `<tr id=${employee.id}>
                    <td>${index}</td>
                    <td>
      ...
      employee.firstname + " " + employee.lastname
                    ...
                    <td>${
                      showMin ? employee.minAmount : employee.maxAmount
                    }</td>
                    <td><i class="fa fa-trash-o" style="font-size:24px" onclick="removeEmployee(${
                      employee.id
                    })"></i>
                    </td>
                </tr>`;
